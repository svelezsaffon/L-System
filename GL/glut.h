...
extern void APIENTRY glutProcessEvents_TBS(void);

/* GLUT window sub-API. */
extern int APIENTRY glutCreateWindow(const char *title);
extern int APIENTRY glutCreateSharedWindow_TBS(const char *title, int sharedId);
...
extern void APIENTRY glutDestroySharedWindow_TBS(int win);
